...
namespace PDSim.Animation
{
    ...
    public class TranslateToObject : WaitUnit
    {
        ...
        protected override IEnumerator Await(Flow flow)
        {
            ...
            var goal = targetObj.transform.position + targetObjOffset.localPosition - movingObjOffset.localPosition;
        ...
        protected override void Definition()
        {
            ...
            targetObjectOffset = ValueInput<Transform>("Target obj Offset");

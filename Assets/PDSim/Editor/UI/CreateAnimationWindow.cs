...
namespace Editor.UI
{
    ...
    public class CreateAnimationWindow : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            // Import UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/PDSim/UI/EditorUI/CreateAnimationDialog.uxml");
        ...
        private void CreateAnimation()
        {
            ...
            // Load the prefab
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/PDSim/Prefabs/Fluent Animation.prefab");

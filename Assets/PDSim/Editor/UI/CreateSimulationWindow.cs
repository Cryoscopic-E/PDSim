...
namespace Editor.UI
{
    public class CreateSimulationWindow : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            // Import UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/PDSim/UI/EditorUI/CreateSimulationWindow.uxml");
        ...
        private void CreateSimulationScene()
        {
            var sceneTemplate =
                AssetDatabase.LoadAssetAtPath<SceneTemplateAsset>(
                    "Assets/PDSim/Scenes/Templates/PdSimSimulationScene.scenetemplate");

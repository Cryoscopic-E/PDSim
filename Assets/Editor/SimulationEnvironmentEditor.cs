        ...
        private void DrawProblemField()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                if (problem != null)
                {
                    ...
                    _simulationEnvironment.objectsPositions = new List<Vector3>();
                    for (int i = 0; i < _simulationEnvironment.objects.Count; i++)
                    {
                        _simulationEnvironment.objectsPositions.Add(new Vector3());
                    }
